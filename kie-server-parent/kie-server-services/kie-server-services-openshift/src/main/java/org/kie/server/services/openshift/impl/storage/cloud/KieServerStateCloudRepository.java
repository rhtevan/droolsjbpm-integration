...
public abstract class KieServerStateCloudRepository implements KieServerStateRepository, CloudClientFactory {
    ...
    /**
     *  To be refactored into org.kie.workbench.common.screens.server.management.utils.ControllerUtils class
     *  by separate PR
     */
    public static final String CFG_KIE_CONTROLLER_OCP_GLOBAL_DISCOVERY_ENABLED = 
            "org.kie.workbench.controller.openshift.global.discovery.enabled";
